# Community Plugins Catalog - Backstage SaaS Platform

This document tracks all available community plugins from the [backstage/community-plugins](https://github.com/backstage/community-plugins) repository's `workspaces` directory and their installation status.

**Last Updated**: December 2024  
**Total Available Plugins**: 96  
**Installed**: 14  
**Installation Progress**: 15%

## 📊 Plugin Categories Overview

| Category | Count | Description |
|----------|-------|-------------|
| **DevOps & CI/CD** | 20 | Build, deployment, and pipeline management |
| **Monitoring & Observability** | 15 | Performance monitoring, logging, and metrics |
| **Security & Quality** | 12 | Code quality, security scanning, and compliance |
| **Cloud Services** | 18 | Cloud provider integrations and services |
| **Developer Experience** | 16 | Tools to enhance developer productivity |
| **Enterprise Tools** | 15 | Enterprise software integrations |

## 📋 Complete Plugin Catalog

### 🔧 DevOps & CI/CD Plugins (20)

| Plugin | Package Name | Status | Priority | Description |
|--------|--------------|--------|----------|-------------|
| **github-actions** | `@backstage-community/plugin-github-actions` | ⏳ Pending | P0 | GitHub Actions workflow integration |
| **jenkins** | `@backstage-community/plugin-jenkins` | ⏳ Pending | P1 | Jenkins CI/CD integration |
| **tekton** | `@backstage-community/plugin-tekton` | ⏳ Pending | P1 | Tekton Pipelines integration |
| **azure-devops** | `@backstage-community/plugin-azure-devops` | ⏳ Pending | P1 | Azure DevOps integration |
| **bitrise** | `@backstage-community/plugin-bitrise` | ⏳ Pending | P2 | Bitrise mobile CI/CD |
| **cloudbuild** | `@backstage-community/plugin-cloudbuild` | ⏳ Pending | P2 | Google Cloud Build integration |
| **gocd** | `@backstage-community/plugin-gocd` | ⏳ Pending | P2 | GoCD continuous delivery |
| **octopus-deploy** | `@backstage-community/plugin-octopus-deploy` | ⏳ Pending | P2 | Octopus Deploy integration |
| **github-deployments** | `@backstage-community/plugin-github-deployments` | ⏳ Pending | P2 | GitHub deployment tracking |
| **cicd-statistics** | `@backstage-community/plugin-cicd-statistics` | ⏳ Pending | P2 | CI/CD statistics and analytics |
| **git-release-manager** | `@backstage-community/plugin-git-release-manager` | ⏳ Pending | P2 | Git release management |
| **gitops-profiles** | `@backstage-community/plugin-gitops-profiles` | ⏳ Pending | P2 | GitOps profile management |
| **scaffolder-backend-module-annotator** | `@backstage-community/scaffolder-backend-module-annotator` | ⏳ Pending | P2 | Scaffolder annotation module |
| **scaffolder-backend-module-kubernetes** | `@backstage-community/scaffolder-backend-module-kubernetes` | ⏳ Pending | P2 | Scaffolder Kubernetes module |
| **scaffolder-backend-module-regex** | `@backstage-community/scaffolder-backend-module-regex` | ⏳ Pending | P2 | Scaffolder regex module |
| **scaffolder-backend-module-servicenow** | `@backstage-community/scaffolder-backend-module-servicenow` | ⏳ Pending | P2 | Scaffolder ServiceNow module |
| **scaffolder-backend-module-sonarqube** | `@backstage-community/scaffolder-backend-module-sonarqube` | ⏳ Pending | P2 | Scaffolder SonarQube module |
| **scaffolder-relation-processor** | `@backstage-community/scaffolder-relation-processor` | ⏳ Pending | P2 | Scaffolder relation processor |
| **repo-tools** | `@backstage-community/plugin-repo-tools` | ⏳ Pending | P3 | Repository management tools |
...
### ☁️ Cloud Services Plugins (18)

| Plugin | Package Name | Status | Priority | Description |
|--------|--------------|--------|----------|-------------|
| **azure-resources** | `@backstage-community/plugin-azure-resources` | ⏳ Pending | P1 | Azure resource management |
| **azure-sites** | `@backstage-community/plugin-azure-sites` | ⏳ Pending | P1 | Azure App Service sites |
| **azure-storage-explorer** | `@backstage-community/plugin-azure-storage-explorer` | ⏳ Pending | P1 | Azure Storage explorer |
| **gcp-projects** | `@backstage-community/plugin-gcp-projects` | ⏳ Pending | P1 | Google Cloud Platform projects |
| **acr** | `@backstage-community/plugin-acr` | ⏳ Pending | P2 | Azure Container Registry |
| **quay** | `@backstage-community/plugin-quay` | ⏳ Pending | P2 | Red Hat Quay container registry |
| **vault** | `@backstage-community/plugin-vault` | ⏳ Pending | P1 | HashiCorp Vault secrets |
| **nomad** | `@backstage-community/plugin-nomad` | ⏳ Pending | P2 | HashiCorp Nomad orchestration |
| **kiali** | `@backstage-community/plugin-kiali` | ⏳ Pending | P2 | Kiali service mesh observability |
| **linkerd** | `@backstage-community/plugin-linkerd` | ⏳ Pending | P2 | Linkerd service mesh |
| **kafka** | `@backstage-community/plugin-kafka` | ⏳ Pending | P2 | Apache Kafka messaging |
| **nexus-repository-manager** | `@backstage-community/plugin-nexus-repository-manager` | ⏳ Pending | P2 | Nexus Repository Manager |
| **jfrog-artifactory** | `@backstage-community/plugin-jfrog-artifactory` | ⏳ Pending | P2 | JFrog Artifactory |
| **3scale** | `@backstage-community/plugin-3scale` | ⏳ Pending | P2 | Red Hat 3scale API management |
| **redhat-argocd** | `@backstage-community/plugin-redhat-argocd` | ⏳ Pending | P1 | Red Hat ArgoCD GitOps |
| **acs** | `@backstage-community/plugin-acs` | ⏳ Pending | P2 | Red Hat Advanced Cluster Security |
| **ocm** | `@backstage-community/plugin-ocm` | ⏳ Pending | P2 | Red Hat OpenShift Cluster Manager |
| **odo** | `@backstage-community/plugin-odo` | ⏳ Pending | P2 | OpenShift Do (odo) developer tool |

### 👨‍💻 Developer Experience Plugins (16)

| Plugin | Package Name | Status | Priority | Description |
|--------|--------------|--------|----------|-------------|
| **github-issues** | `@backstage-community/plugin-github-issues` | ⏳ Pending | P0 | GitHub issues integration |
| **github-discussions** | `@backstage-community/plugin-github-discussions` | ⏳ Pending | P1 | GitHub discussions |
| **github-pull-requests-board** | `@backstage-community/plugin-github-pull-requests-board` | ⏳ Pending | P1 | GitHub PR dashboard |
| **todo** | `@backstage-community/plugin-todo` | ⏳ Pending | P1 | TODO tracking in code |
| **bookmarks** | `@backstage-community/plugin-bookmarks` | ⏳ Pending | P2 | Personal bookmarks |
| **shortcuts** | `@backstage-community/plugin-shortcuts` | ⏳ Pending | P2 | Quick access shortcuts |
| **adr** | `@backstage-community/plugin-adr` | ⏳ Pending | P1 | Architecture Decision Records |
| **tech-radar** | `@backstage-community/plugin-tech-radar` | ⏳ Pending | P1 | Technology radar |
| **linguist** | `@backstage-community/plugin-linguist` | ⏳ Pending | P2 | Programming language detection |
| **badges** | `@backstage-community/plugin-badges` | ⏳ Pending | P2 | Project badges |
| **explore** | `@backstage-community/plugin-explore` | ⏳ Pending | P2 | Content exploration |
| **feedback** | `@backstage-community/plugin-feedback` | ⏳ Pending | P2 | User feedback system |
| **entity-feedback** | `@backstage-community/plugin-entity-feedback` | ⏳ Pending | P2 | Entity-specific feedback |
| **stack-overflow** | `@backstage-community/plugin-stack-overflow` | ⏳ Pending | P2 | Stack Overflow integration |
| **npm** | `@backstage-community/plugin-npm` | ⏳ Pending | P2 | NPM package information |
